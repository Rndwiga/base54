          ...
          <div class="ibox-content">
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                <?php echo Form::model($user, ['action' => ['Admin\UsersController@update', $user->id], 'method' => 'patch', 'class'=> 'form-horizontal form-label-left', 'files' => true ]); ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <?php echo e(Form::select('is_active', array(1 => 'Activate', 0 => 'Deactivated'), null, ['class' => 'form-control col-md-7 col-xs-12'])); ?>
